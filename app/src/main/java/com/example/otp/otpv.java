...
public class otpv extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final Button otp = findViewById(R.id.buttongetotp2);
            ...
            public void onClick(View v)
            {
                if (!inputnumber1.getText().toString().trim().isEmpty() &&
                    ...
                    if (getotpbackend!=null){
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()){
                                            ...
                                            Toast.makeText(otpv.this,"enter the correct otp",Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                        ...
                        Toast.makeText(otpv.this,"Please check internet connection",Toast.LENGTH_SHORT).show();
                    }


                } else
                {
                    Toast.makeText(otpv.this, "please enter all numbers", Toast.LENGTH_SHORT).show();
                }
            }
        });
        numberotpmove();
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(otpv.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(otpv.this,"otp sccessfully send",Toast.LENGTH_SHORT).show();
                            }
                        }
                );
            }
